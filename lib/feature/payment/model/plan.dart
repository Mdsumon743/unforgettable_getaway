...
class Plan {
  ...
  final String? description;
  final String priceId;
  final String? paypalProductId; // Changed to nullable
  final String? paypalPlanId; // Changed to nullable
  final DateTime createdAt;
  final DateTime updatedAt;
  ...
  factory Plan.fromJson(Map<String, dynamic> json) {
    return Plan(
      ...
      description: json['description'] as String?,
      priceId: json['priceId'] as String,
      paypalProductId: json['paypalProductId'] as String?, // Handle nullable field
      paypalPlanId: json['paypalPlanId'] as String?, // Handle nullable field
      createdAt: DateTime.parse(json['createdAt'] as String),
      updatedAt: DateTime.parse(json['updatedAt'] as String),
    );
  }
